...
if (Powerup_Creep_Enabled isEqualTo 2) exitwith 
{
	...
	switch (_Powerup) do
	{
		case 1 : { [] call NJP_Powerup_Fnc_Bunny_IED; };
		case 2 : { [] call NJP_Powerup_Fnc_Bomb; };
		case 3 : { [] call NJP_Powerup_Fnc_Banana; };
		case 4 : { [] call NJP_Powerup_Fnc_Involuntary_Boost; };
		case 5 : { [] call NJP_Powerup_Fnc_Triple_Bomb; };
		case 6 : { [] call NJP_Powerup_Fnc_Lightning; };
		case 7 : { [] call NJP_Powerup_Fnc_Banana_Gun; };
		case 8 : { [] call NJP_Powerup_Fnc_Smoke_Screen; };
		case 9 : { [] call NJP_Powerup_Fnc_Triple_Boost; };
		case 10 : { [] call NJP_Powerup_Fnc_Boost; };
		case 11 : { [] call NJP_Powerup_Fnc_Triple_Banana; };
		case 12 : { [] call NJP_Powerup_Fnc_Kitchen_sink; };
		case 13 : { [] call NJP_Powerup_Fnc_Miller; };
...
if (Current_Place isEqualTo 1) exitwith 
{
	...
	switch (_Powerup) do
	{
		case 1 : { [] call NJP_Powerup_Fnc_Smoke_Screen; };
		case 2 : { [] call NJP_Powerup_Fnc_Bunny_IED; };
		case 3 : { [] call NJP_Powerup_Fnc_Bomb; };
		case 4 : { [] call NJP_Powerup_Fnc_Banana; };
	};
};
...
if (Current_Place > 1 && Current_Place <= (_Count_Racers * 0.2)) exitwith 
{
	...
	switch (_Powerup) do
	{
		...
		case 11 : { [] call NJP_Powerup_Fnc_Triple_Banana; };
		case 12 : { [] call NJP_Powerup_Fnc_Kitchen_sink; };
		case 13 : { [] call NJP_Powerup_Fnc_Change_Mass; };
	}
};
...
if (Current_Place >= (_Count_Racers * 0.4) && Current_Place <= (_Count_Racers * 0.6)) exitwith 
{
	...
	switch (_Powerup) do
	{
		...
		case 6 : { [] call NJP_Powerup_Fnc_Lightning; };
		case 7 : { [] call NJP_Powerup_Fnc_Banana_Gun; };
		case 8 : { [] call NJP_Powerup_Fnc_Triple_Boost; };
		case 9 : { [] call NJP_Powerup_Fnc_Triple_Boost; };
		case 10 : { [] call NJP_Powerup_Fnc_Boost; };
		case 11 : { [] call NJP_Powerup_Fnc_Boost; };
		case 12 : { [] call NJP_Powerup_Fnc_Kitchen_sink; };
		case 13 : { [] call NJP_Powerup_Fnc_Miller; };
		case 14 : { [] call NJP_Powerup_Fnc_Washing_Machine; };
		case 15 : { [] call NJP_Powerup_Fnc_Fus_Ro_Dah; };
		case 16 : { [] call NJP_Powerup_Fnc_Change_Mass; };
		case 17 : { [] call NJP_Powerup_Fnc_Blue_Shell; };
	};
};
...
if (Current_Place >= (_Count_Racers * 0.6) && Current_Place <= (_Count_Racers * 0.8)) exitwith 
{
	...
	_Powerup = [1,9] call BIS_fnc_randomInt;

	switch (_Powerup) do
	{
		case 1 : { [] call NJP_Powerup_Fnc_Involuntary_Boost; };
		case 2 : { [] call NJP_Powerup_Fnc_Triple_Bomb; };
		case 3 : { [] call NJP_Powerup_Fnc_Lightning; };
		case 4 : { [] call NJP_Powerup_Fnc_Triple_Boost; };
		case 5 : { [] call NJP_Powerup_Fnc_Boost; };
		case 6 : { [] call NJP_Powerup_Fnc_Kitchen_sink; };
		case 7 : { [] call NJP_Powerup_Fnc_Miller; };
		case 8 : { [] call NJP_Powerup_Fnc_Fus_Ro_Dah; };
		case 9 : { [] call NJP_Powerup_Fnc_CP_Tele; };
	};
};
...
if (Current_Place >= (_Count_Racers * 0.8) && Current_Place <= _Count_Racers) exitwith 
{
	...
	switch (_Powerup) do
	{
		case 1 : { [] call NJP_Powerup_Fnc_Lightning; };
		case 2 : { [] call NJP_Powerup_Fnc_Triple_Boost; };
		case 3 : { [] call NJP_Powerup_Fnc_CP_Tele; };
		case 4 : { [] call NJP_Powerup_Fnc_Kitchen_sink; };
		case 5 : { [] call NJP_Powerup_Fnc_Boost; };
		case 6 : { [] call NJP_Powerup_Fnc_CP_Tele; };
		case 7 : { [] call NJP_Powerup_Fnc_Blue_Shell; };
	};
};